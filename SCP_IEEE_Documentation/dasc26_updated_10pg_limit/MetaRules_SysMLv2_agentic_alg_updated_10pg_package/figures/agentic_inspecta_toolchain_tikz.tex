...
\begin{tikzpicture}[x=1pt,y=-1pt]
  ...
  \node[agentTitle] at (-89,12) {Agentic SCP Copilot};
  ...
  % Generated candidate specification arrow
  ...
  \draw[haDataArrow] (75.55,74.27) -- (75.55,151.27);
  \draw[haDataArrow] (95.99,43.33) -- (95.99,183.79);
  \draw[haDataArrow] (133.34,58.80) -- (133.34,161.76);
  \draw[haDataArrow] (163.82,62.58) -- (163.82,167.38);
  ...
  \draw[failArrow] (356,39.88) -- (340,39.88) -- (340,323) -- (-18,323) -- (-18,287) -- (-25,287);
  \node[noteText, fill=white, text=agentRed] at (176,321) {failure diagnostics returned to repair agent};
  \node[noteText, fill=white] at (321,24) {green dashed: proofs when checks pass};

  % Labels.
  \node[haText,anchor=west] at (5.95,6.81) {System Architecture Model};
  \node[haText,anchor=west] at (23.11,31.01) {AGREE/GUMBO Contract};
  \node[haText,anchor=west] at (47.42,55.41) {Component};
  \node[haText,anchor=west] at (153.04,31.01) {AGREE/GUMBO Contract};
  ...
  \node[haText,align=left,anchor=west] at (5.95,144.91) {Infrastructure Code\\(defaults to Slang/Scala)};
  \node[haText,align=left,anchor=west] at (267.41,144.91) {JVM\\seL4};
  ...
  \node[haProofText] at (61.40,186.81) {Logika/Verus\\checkable contracts};
  \node[haText,align=center] at (63.18,207.50) {Rust/C/Slang};
  \node[haText,anchor=west] at (168.22,171.81) {Component Stub};
  \node[haProofText] at (198.40,186.81) {Logika/Verus\\checkable contracts};
  \node[haText,align=center] at (200.50,207.50) {Rust/C/Slang};
  \node[haMicro, anchor=south] at (132.70,176.91) {AP};
